#ifndef TURTLEBOT_EXPLORATION_HEADER
#define TURTLEBOT_EXPLORATION_HEADER
...
public:
    ...
    void signCB(const exploration_perception::DangerSign::ConstPtr&);
    ...
    void moveBaseFeedbackCB(const geometry_msgs::PoseStamped::ConstPtr&);
    void explorationFeedbackCB(const geometry_msgs::PoseStamped::ConstPtr&, const geometry_msgs::PoseStamped::ConstPtr&);
